 ...
 */
public class FindBudgetsByUserIdPaginated {
     ...
     * @author Ricard Pinilla Barnes
     */
    public FindBudgetsByUserIdPaginated(Context context, ReformBudgetService service) {
     ...
     * @author Ricard Pinilla Barnes
     */
    public MutableLiveData<List<ReformBudget>> findAllBudgetsByUserIdPaginated(long userId) {

        budgetService.findAllUserBudgetsByUserIdPaginated(userId, startPosition, OBJECT_LIMIT)
                        ...
                        if (responseCode == 200) {
                            ...
                            if (reformBudgets != null) {
                                if (!reformBudgets.isEmpty()) {
                                    ...
                                    findAllBudgetsByUserIdPaginated(userId);
                                } else {
                                    finishCall();
                                }
                            }
